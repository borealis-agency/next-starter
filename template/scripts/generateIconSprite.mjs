...
const getAllSvgFilesPaths = () => glob.sync("./src/icons/**/*.svg", {
	// Use posix flag to ensure that the paths returned are always in posix format (/) even on Windows
	posix: true
});
...
// biome-ignore format: this is autogenerated code we don't want to format
